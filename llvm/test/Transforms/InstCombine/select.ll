...
define i16 @fold_select_of_lshr_bug184131(i16 %x, i16 %y) {
; CHECK-LABEL: define i16 @fold_select_of_lshr_bug184131(
; CHECK-SAME: i16 [[X:%.*]], i16 [[Y:%.*]]) {
; CHECK-NEXT:    [[X_B8:%.*]] = and i16 [[X]], 256
; CHECK-NEXT:    [[CND_NOT:%.*]] = icmp eq i16 [[X_B8]], 0
; CHECK-NEXT:    [[SEL_XY_V:%.*]] = select i1 [[CND_NOT]], i16 [[Y]], i16 [[X]]
; CHECK-NEXT:    [[SEL_XY:%.*]] = and i16 [[SEL_XY_V]], -256
; CHECK-NEXT:    [[SEL_XY_V1:%.*]] = select i1 [[CND_NOT]], i16 [[Y]], i16 [[X]]
; CHECK-NEXT:    [[LO:%.*]] = and i16 [[SEL_XY_V1]], 255
; CHECK-NEXT:    [[OUT:%.*]] = or disjoint i16 [[SEL_XY]], [[LO]]
