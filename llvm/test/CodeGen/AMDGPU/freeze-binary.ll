...
; CHECK-NEXT:    v_dual_mul_f32 v11, 0.5, v1 :: v_dual_mul_f32 v16, 0x3e800000, v3
...
; CHECK-NEXT:    v_trunc_f32_e32 v16, v16
; CHECK-NEXT:    v_trunc_f32_e32 v13, v0
; CHECK-NEXT:    s_waitcnt_depctr depctr_va_vdst(0)
; CHECK-NEXT:    v_fma_f32 v15, -v8, v10, 1.0
; CHECK-NEXT:    v_fma_f32 v18, -v9, v12, 1.0
; CHECK-NEXT:    v_mul_f32_e32 v17, 0x3e800000, v4
; CHECK-NEXT:    v_fmac_f32_e32 v1, -2.0, v11
; CHECK-NEXT:    v_div_scale_f32 v11, s0, v5, 0x40400000, v5
; CHECK-NEXT:    v_fmac_f32_e32 v10, v15, v10
; CHECK-NEXT:    v_fmac_f32_e32 v12, v18, v12
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; CHECK-NEXT:    v_div_scale_f32 v18, null, 0x40400000, 0x40400000, v1
; CHECK-NEXT:    v_trunc_f32_e32 v17, v17
; CHECK-NEXT:    v_dual_mul_f32 v15, v14, v10 :: v_dual_mul_f32 v20, v11, v12
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; CHECK-NEXT:    v_rcp_f32_e32 v22, v18
; CHECK-NEXT:    v_fma_f32 v21, -v8, v15, v14
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; CHECK-NEXT:    v_fma_f32 v23, -v9, v20, v11
; CHECK-NEXT:    v_dual_mul_f32 v19, 0.5, v6 :: v_dual_fmac_f32 v20, v23, v12
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
; CHECK-NEXT:    v_trunc_f32_e32 v19, v19
; CHECK-NEXT:    v_fmac_f32_e32 v15, v21, v10
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; CHECK-NEXT:    v_fma_f32 v9, -v9, v20, v11
; CHECK-NEXT:    v_fmac_f32_e32 v6, -2.0, v19
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
; CHECK-NEXT:    v_fma_f32 v8, -v8, v15, v14
; CHECK-NEXT:    v_fma_f32 v14, -v18, v22, 1.0
; CHECK-NEXT:    v_div_scale_f32 v11, s1, v1, 0x40400000, v1
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; CHECK-NEXT:    v_div_scale_f32 v19, null, 0x40400000, 0x40400000, v6
; CHECK-NEXT:    v_div_fmas_f32 v8, v8, v10, v15
; CHECK-NEXT:    s_mov_b32 vcc_lo, s0
; CHECK-NEXT:    v_div_fmas_f32 v9, v9, v12, v20
; CHECK-NEXT:    v_mov_b32_e32 v12, v16
; CHECK-NEXT:    v_fmac_f32_e32 v22, v14, v22
; CHECK-NEXT:    v_div_fixup_f32 v8, v8, 0x40400000, v2
; CHECK-NEXT:    v_rcp_f32_e32 v10, v19
; CHECK-NEXT:    v_div_fixup_f32 v9, v9, 0x40400000, v5
; CHECK-NEXT:    v_dual_fmac_f32 v3, -4.0, v12 :: v_dual_sub_f32 v0, v0, v13
; CHECK-NEXT:    v_mul_f32_e32 v13, v11, v22
; CHECK-NEXT:    v_trunc_f32_e32 v8, v8
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; CHECK-NEXT:    v_trunc_f32_e32 v9, v9
; CHECK-NEXT:    s_mov_b32 vcc_lo, s1
; CHECK-NEXT:    v_fmac_f32_e32 v2, 0xc0400000, v8
; CHECK-NEXT:    v_fma_f32 v8, -v18, v13, v11
; CHECK-NEXT:    s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; CHECK-NEXT:    v_fma_f32 v14, -v19, v10, 1.0
; CHECK-NEXT:    v_dual_fmac_f32 v13, v8, v22 :: v_dual_mov_b32 v8, v17
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; CHECK-NEXT:    v_fmac_f32_e32 v10, v14, v10
; CHECK-NEXT:    v_div_scale_f32 v14, s0, v6, 0x40400000, v6
; CHECK-NEXT:    v_fmac_f32_e32 v4, -4.0, v8
; CHECK-NEXT:    v_mov_b32_e32 v8, v9
; CHECK-NEXT:    v_fma_f32 v9, -v18, v13, v11
; CHECK-NEXT:    v_trunc_f32_e32 v11, v7
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; CHECK-NEXT:    v_fmac_f32_e32 v5, 0xc0400000, v8
; CHECK-NEXT:    v_div_fmas_f32 v9, v9, v22, v13
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; CHECK-NEXT:    v_dual_mov_b32 v8, v11 :: v_dual_mul_f32 v11, 0x3e800000, v0
; CHECK-NEXT:    v_mul_f32_e32 v12, v14, v10
; CHECK-NEXT:    s_mov_b32 vcc_lo, s0
; CHECK-NEXT:    v_div_fixup_f32 v9, v9, 0x40400000, v1
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(VALU_DEP_4)
; CHECK-NEXT:    v_sub_f32_e32 v7, v7, v8
; CHECK-NEXT:    v_trunc_f32_e32 v8, v11
; CHECK-NEXT:    v_fma_f32 v15, -v19, v12, v14
; CHECK-NEXT:    v_mul_f32_e32 v13, 0.5, v2
; CHECK-NEXT:    v_trunc_f32_e32 v9, v9
; CHECK-NEXT:    v_fmac_f32_e32 v0, -4.0, v8
; CHECK-NEXT:    v_mul_f32_e32 v8, 0.5, v5
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; CHECK-NEXT:    v_trunc_f32_e32 v13, v13
; CHECK-NEXT:    v_fmac_f32_e32 v1, 0xc0400000, v9
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; CHECK-NEXT:    v_trunc_f32_e32 v8, v8
; CHECK-NEXT:    v_fmac_f32_e32 v12, v15, v10
; CHECK-NEXT:    v_dual_fmac_f32 v2, -2.0, v13 :: v_dual_fmac_f32 v5, -2.0, v8
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; CHECK-NEXT:    v_fma_f32 v11, -v19, v12, v14
; CHECK-NEXT:    v_div_fmas_f32 v10, v11, v10, v12
...
; CHECK-NEXT:    v_dual_sub_f32 v3, v3, v11 :: v_dual_sub_f32 v4, v4, v12
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; CHECK-NEXT:    v_trunc_f32_e32 v9, v9
