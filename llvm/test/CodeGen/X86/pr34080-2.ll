...
; CHECK-NEXT:    movl 8(%edi), %ebx
; CHECK-NEXT:    xorl %eax, %eax
; CHECK-NEXT:    cmpl $3, 12(%edi)
; CHECK-NEXT:    setl %al
; CHECK-NEXT:    subl %eax, %ebx
; CHECK-NEXT:    movl $-1374389535, %eax # imm = 0xAE147AE1
; CHECK-NEXT:    imull %ebx
; CHECK-NEXT:    movl %edx, %ecx
; CHECK-NEXT:    movl %edx, %eax
; CHECK-NEXT:    shrl $31, %eax
; CHECK-NEXT:    sarl $5, %ecx
; CHECK-NEXT:    addl %eax, %ecx
; CHECK-NEXT:    movl $1374389535, %eax # imm = 0x51EB851F
; CHECK-NEXT:    imull %ebx
...
; CHECK-NEXT:    imull $36525, %ebx, %edx # imm = 0x8EAD
; CHECK-NEXT:    addl $172251900, %edx # imm = 0xA445AFC
; CHECK-NEXT:    movl $1374389535, %eax # imm = 0x51EB851F
...
; CHECK-NEXT:    fldcw {{[0-9]+}}(%esp)
; CHECK-NEXT:    movb $1, 36(%edi)
; CHECK-NEXT:    imull $3600000, 20(%edi), %ecx # imm = 0x36EE80
; CHECK-NEXT:    imull $60000, 24(%edi), %eax # imm = 0xEA60
; CHECK-NEXT:    addl %ecx, %eax
; CHECK-NEXT:    movl %eax, %ecx
; CHECK-NEXT:    sarl $31, %ecx
; CHECK-NEXT:    fldl 28(%edi)
; CHECK-NEXT:    fmuls {{\.?LCPI[0-9]+_[0-9]+}}
; CHECK-NEXT:    fnstcw {{[0-9]+}}(%esp)
