...
; CHECK-NEXT:    movl $1336530590, %eax # imm = 0x4FA9D69E
...
; CHECK-NEXT:    addl %ebx, %edx
; CHECK-NEXT:    shrdl $3, %ecx, %edi
; CHECK-NEXT:    sarl $3, %ecx
; CHECK-NEXT:    orl %edx, %ecx
; CHECK-NEXT:    orl %eax, %edi
; CHECK-NEXT:    movl $-66860409, %eax # imm = 0xFC03CA87
; CHECK-NEXT:    mull %edi
...
; CHECK-NEXT:    movl $1419758215, %eax # imm = 0x549FCA87
; CHECK-NEXT:    mull %ecx
