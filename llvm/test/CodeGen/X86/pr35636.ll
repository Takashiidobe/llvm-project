...
; HSW:       # %bb.0: # %bb
; HSW-NEXT:    movabsq $811296384146066817, %rdx # imm = 0xB424DC35095CD81
; HSW-NEXT:    mulxq %rdi, %rax, %rax
...
; ZN:       # %bb.0: # %bb
; ZN-NEXT:    movabsq $811296384146066817, %rdx # imm = 0xB424DC35095CD81
; ZN-NEXT:    mulxq %rdi, %rax, %rax
; ZN-NEXT:    shrq $42, %rax
